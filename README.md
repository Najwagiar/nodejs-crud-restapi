...
## Tentang Project
Project ini merupakan pengembangan RESTful API sederhana yang mendukung operasi CRUD (Create, Read, Update, Delete). 
Aplikasi ini dirancang untuk mengelola data katalog yang terdiri dari entitas Kategori dan Produk, dengan relasi one-to-many di mana setiap produk dikaitkan dengan kategori tertentu.
